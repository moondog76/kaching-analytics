          ...
          <div className="max-w-7xl mx-auto px-8 py-5 flex justify-between items-center">
            <div className="flex items-center gap-6">
              ...
              <nav className="flex gap-1">
                ...
                <a
                  href="/analytics"
                  className="px-4 py-2 rounded-lg text-sm font-medium text-slate-600 hover:text-slate-900 hover:bg-slate-100 transition-all flex items-center gap-2"
                >
                ...
                >
                  ...
                  Retail Insights
                  <span className="bg-pluxee-ultra-green text-pluxee-deep-blue text-xs font-medium px-2 py-0.5 rounded-full">Pro</span>
                </a>
                <a
                  href="/settings"
